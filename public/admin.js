(() => {
  ...
  function typeIcon(type){return ({'Native Note':'▤','PDF Note':'▤','Video':'▶','Mock Test':'◇','Current Affairs':'◎','Roadmap':'⇢','Live Class':'●','Replay':'↺'})[type]||'▤';}
  function thumb(type){return ({'Native Note':['#dfe9ff','#fff4e4'],'PDF Note':['#e8eff8','#f7f9fc'],'Video':['#dfe9ff','#e8f8f2'],'Mock Test':['#fff0e8','#fff7df'],'Current Affairs':['#ffeaf2','#fff0f1'],'Roadmap':['#e8f8f2','#eaf8e3'],'Live Class':['#fff0e8','#fff7df'],'Replay':['#ede9ff','#dfe9ff']})[type]||['#e8eff8','#f7f9fc'];}
  ...
  function contextCount(parent,id){
    ...
    if(parent==='content'){
      ...
      if(id==='live-replays')return data.resources.filter(x=>['Live Class','Replay'].includes(x.type)).length;
  ...
  function filteredResources(){
    ...
    const map={notes:['Native Note','PDF Note'],videos:['Video'],'mock-tests':['Mock Test'],'current-affairs':['Current Affairs'],roadmaps:['Roadmap'],'live-replays':['Live Class','Replay'],drafts:['Draft','Staged']};
