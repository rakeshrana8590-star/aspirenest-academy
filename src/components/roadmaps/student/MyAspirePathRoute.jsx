    ...
    <RoadmapShell>
      <AspirePathHero
        ...
        metrics={[
          ...
          {
            value: user ? catchUpCards.length || 0 : "Login",
            label: "Pending",
          },
                ...
                >
                  <div className="aspirePathCardTop">
                    <div>
                      ...
                      <p className="aspirePathCardText">{roadmap.title}</p>
                    </div>

                    <RoadmapBadge>{pendingCount} Pending</RoadmapBadge>
                  </div>
                  ...
                  <div className="aspirePathResourceRow">
                    ...
                    <RoadmapBadge>{day.dayType || "study"}</RoadmapBadge>
                  </div>
